...
import stis.ks2.group2.eventagenda.activities.EventKuActivity;
import stis.ks2.group2.eventagenda.model.Events;

public class
RecyclerViewAdapterEventKu extends RecyclerView.Adapter<RecyclerViewAdapterEventKu.MyViewHolder> {
    private RequestOptions opsi;
    private Context mContext;
    private List<Events> mData;

    public RecyclerViewAdapterEventKu(Context mContext, List<Events> mData) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        viewHolder.view_container.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(mContext, EventKuActivity.class);
