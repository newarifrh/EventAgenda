...
import stis.ks2.group2.eventagenda.activities.ManageEventActivity;
import stis.ks2.group2.eventagenda.model.Events;

public class RecyclerViewAdapterManage extends RecyclerView.Adapter<RecyclerViewAdapterManage.MyViewHolder> {
    private RequestOptions opsi;
    private Context mContext;
    private List<Events> mData;

    public RecyclerViewAdapterManage(Context mContext, List<Events> mData) {
